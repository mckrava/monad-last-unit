...
The keys live in `.claude/settings.json` (project) or `/Users/maximkravchuk/Development/Projects/Monad/blitz-hackathon/last-unit/.claude/settings.json` (global) — **not** in `.planning/config.json`:
