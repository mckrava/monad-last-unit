...
**Verification depth scales with `asvs_level`** (see @/Users/maximkravchuk/Development/Projects/Monad/blitz-hackathon/last-unit/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
